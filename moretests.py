...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.textbox.grid(row=0, column=0, columnspan=1, padx=20, pady=(20, 0), sticky="nsew")
        ...
        self.slider = customtkinter.CTkSlider(self, from_=0, to=1000, command=self.slider_event)
        self.slider.grid(row=0, column=1, padx=20, pady=20, sticky="ew")
